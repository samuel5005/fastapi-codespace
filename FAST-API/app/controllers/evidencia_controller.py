...
class EvidenciaController:
    ...
    def create_evidencia(self, evidencia: Evidencia):   
        try:
            ...
            cursor = conn.cursor()
            cursor.execute("INSERT INTO evidencia (nombre_archivo,tipo_archivo,url,id_incidencia) VALUES (%s, %s, %s, %s)", (user.nombre_archivo, user.tipo_archivo, user.url, user.id_incidencia))
            conn.commit()
            conn.close()
